...
# Alternative for Windows users with Python Launcher
py -m pip install -e .
```
...
After installation, you can verify ShiboScript is properly installed by running:
...
# Create executable
pyinstaller --onefile main.py --name shiboscript
```
