# ShiboScript Language Syntax Reference

This document provides a comprehensive reference to ShiboScript's syntax.
...
```
Program        := Statement*
Statement      := VarDecl | FuncDef | ClassDef | IfStmt | WhileStmt | ForStmt | 
                  DoWhileStmt | TryStmt | ReturnStmt | ExprStmt | ImportStmt | PrintStmt
...
Primary        := NUMBER | STRING | BOOLEAN | "null" | 
                  ...
                  FunctionCall | IndexExpr | AttributeExpr
```

This syntax reference provides a complete overview of ShiboScript's grammar and usage patterns.
