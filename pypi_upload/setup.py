...
def read_requirements():
    ...
    return ["Pillow>=8.0.0"]  # Default requirement
...
setup(
    ...
    project_urls={
        ...
        "Changelog": "https://github.com/ShiboShreeRoy/ShiboScript/blob/main/HISTORY.md",
    },
    license="MIT",
    classifiers=[
    ...
    package_data={
        "shiboscript": ["*.md", "*.txt", "*.ico", "assets/*", "templates/*", "config/*"],
    },
    keywords="scripting language interpreter education automation programming-language",
    zip_safe=False,
    platforms=["any"],
    provides=["shiboscript"],
    requires=["Pillow"],
)
